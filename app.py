...
//  description   public profile discovery CLI
//  license       AGPL-3.0
//  -------------------------------------------------------------
"""
...
class ClueMesh():
    ...
    def init_logic(self):
        ...
        self.languages_json = self.load_file("languages.json", self.languages_path, "https://raw.githubusercontent.com/tsingke/cluemesh/main/data/languages.json")
        self.sites_dummy = self.load_file("sites.json", self.sites_path, "https://raw.githubusercontent.com/tsingke/cluemesh/main/data/sites.json")
    ...
    def run_as_cli(self):
        ...
        ret = {}
        ARGV = None
        ARG_PARSER = _ArgumentParser(description="ClueMesh - public profile discovery and identity clue correlation across 900+ websites", usage=SUPPRESS)
        ...
        ARG_PARSER_OPTIONAL.add_argument("--metadata", help="Extract public profile metadata if possible", action="store_true")
