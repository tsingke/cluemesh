...
async function visualize_force_graph (req, detected, type) {
  try {
    const graph = new QBIxora('ClueMesh', false)
    ...
    const ret_graph = graph.create_graph('#ixora-graph', 'ClueMesh evidence graph', 'Search', 'Search extracted patterns', 'https://github.com/tsingke/cluemesh', 'ClueMesh', ['search', 'tooltip'], 10, 100, graph.graph, 'object', undefined, undefined)
    return ret_graph
  } catch (err) {
