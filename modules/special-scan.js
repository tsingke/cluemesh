...
function get_geckodriver_path () {
  return geckodriver.path.replace('app.asar', 'app.asar.unpacked')
}
...
async function find_username_site_special_facebook_1 (uuid, username, site) {
  return new Promise(async (resolve, reject) => {
    ...
    const driver = new Builder()
      .forBrowser('firefox')
      .setFirefoxService(new firefox.ServiceBuilder(get_geckodriver_path()))
